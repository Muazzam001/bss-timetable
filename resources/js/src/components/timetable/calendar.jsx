                ...
                <div className='pr-5 flex items-center gap-8'>
                    <button
                        ...
                        <Image src={assets.calendar2} alt="calendar icon"
                               className="w-4"/><span>Dulplicate Calendar</span></button>
                            ...
                            {data.slice(1).map((row, rowIndex) => (
                                <tr key={rowIndex}>
                                    ...
                                    {row.slice(1).map((cell, cellIndex) => {
                                        ...
                                        return (
                                            <td key={cellIndex}
                                                className='font-primary text-xs uppercase w-20 h-20 !p-1'>
                                                <div
                                                    className={`flex flex-col ${cellColor} rounded-sm p-1 text-white border border-blue-dark2`}>
                                                        <span className='flex justify-end gap-1'>
                                                            <LockIcon className='!w-2.5 !h-2.5'/>
                                                            <CloseIcon className='!w-2.5 !h-2.5 border rounded-[2px]'/>
                                                            <MoreVertIcon
                                                                className='!w-2.5 !h-2.5 border rounded-[2px]'/>
                                                        </span>
                                                    <span>
                                                            {cell}
                                                        </span>
