...
const Modal = ({isOpen, onClose, team}) => {
    return (
        <>
            ...
            <div
                className={`fixed top-0 right-0 min-h-screen overflow-y-auto w-[55%] border border-gray-medium transform transition-transform ease-in-out duration-700 bg-gray-light-bluish ${isOpen ? 'translate-x-0' : 'translate-x-full'} z-50`}>
