        ...
        <>
            ...
            <div className="relative mt-1">
                ...
                <input
                    type={type}
                    name={name}
                    className={`inline-block w-full ${rounded ? "rounded-full" : "rounded-lg"} font-primary placeholder:font-primary border-gray-300 hover:border-sky-blue hover:outline-0 hover:ring-0 focus:outline-0 focus:ring-0 bg-input-bg py-4 ${icon ? "pl-15" : "pl-5"} sm:text-sm ${className}`}
