            ...
            <Dialog as="div" className="relative z-50 " onClose={() => console.log("")}>
                <div className="fixed inset-0 z-10">
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        ...
                        >
                            <Dialog.Panel className={`relative transform rounded-lg bg-gray-light-bluish px-4 pt-5 pb-4 text-left transition-all sm:my-8 sm:p-6 border border-gray-dark2`}>
                                <div className={`flex flex-col items-center w-[600px] p-5`}>
                                    <p className='font-primary'>Are you sure you want to change the count of lessons from {`${oldValue}`} to {`${newValue}`}?</p>
